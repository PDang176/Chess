    ...
    possibleMoves(board, start, search){
        ...
        if(start.x - 1 > 0 && start.y - 2 > 0){
            if(board[(8 * (start.y - 3)) + start.x - 2].piece.color !== start.piece.color){
                if(search || !this.kingInCheck(this.createTempBoard(board, start.index, (8 * (start.y - 3)) + start.x - 2))){
        ...
        if(start.x + 1 < 9 && start.y - 2 > 0){
            if(board[(8 * (start.y - 3)) + start.x].piece.color !== start.piece.color){
                if(search || !this.kingInCheck(this.createTempBoard(board, start.index, (8 * (start.y - 3)) + start.x))){
        ...
        if(start.x - 2 > 0 && start.y - 1 > 0){
            if(board[(8 * (start.y - 2)) + start.x - 3].piece.color !== start.piece.color){
                if(search || !this.kingInCheck(this.createTempBoard(board, start.index, (8 * (start.y - 2)) + start.x - 3))){
        ...
        if(start.x - 2 > 0 && start.y + 1 < 9){
            if(board[(8 * (start.y)) + start.x - 3].piece.color !== start.piece.color){
                if(search || !this.kingInCheck(this.createTempBoard(board, start.index, (8 * (start.y)) + start.x - 3))){
